...
echo ===============================================
echo   PlanIFlow - Project Planner v1.5 - One-Click Installer
echo ===============================================
echo.
echo This installer will set up PlanIFlow - Project Planner v1.5
echo.
echo This will:
...
echo ===============================================
echo.
echo Project Planner v1.5 is ready to use!
echo.
...
if /i "!RUN_NOW!"=="Y" (
    echo.
    echo [INFO] Launching Project Planner v1.5...
    echo.
    call run.bat
) else (
    echo.
